...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "Atau Tanaka, RNBO port of 12_16_grain_cloud.maxpat example from Cipriani and Giri , \"Theory and Practice with Max and MSP vol. 3\"\nMay 2024"
				}
...
,
									...
									"patching_rect" : [ 114.5, 183.0, 136.0, 23.0 ],
									"rnbo_classname" : "gen~",
